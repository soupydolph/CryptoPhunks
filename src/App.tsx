    ...
    <>
      <section className="container mx-auto">
        <div className="phunk-intro m-6 lg:m-24">
          <h1 className="font-display text-3xl md:text-6xl text-center text-primary my-7 md:my-24">
            CRYPTOPHUNKS
          </h1>
          <h2 className="font-body text-2xl md:text-5xl text-center text-slate-50 my-7 md:my-14">
            Be Phree, be Phunky
          </h2>
        </div>
      </section>
      ...
      <section className="container mx-auto font-light my-7 md:my-24">
        <div className="w-3/4 mx-auto">
          <p className="text-2xl text-slate-50 text-center my-14">
            Phunks are free-use, public domain Art, run entirely by
            decentralized community of artist and builders.
          </p>

          <p className="text-2xl text-slate-50 text-center my-14">
            There are no Devs, no Leaders, no Roadmaps, just Phunk Pham building
            cool stuff cause they care about Web3 and decentralization. ✊
          </p>

          <p className="text-2xl text-slate-50 text-center mb-24">
            You can buy a Phunk at{" "}
            <Link url="https://notlarvalabs.com/" title="Not Larva Labs" /> or
            the <Link url="https://phunks.auction/" title="Auction House" />{" "}
            with 0% fees! You can learn more about Phunks at the{" "}
            <Link url="https://phunks.gitbook.io/" title="Knowledge Base" />.
          </p>
        </div>
      ...
      <section className="container mx-auto">
        <h2 className="font-body text-4xl md:text-6xl text-center text-slate-50 my-7 md:my-14">
          Phunky Projects
        </h2>
        ...
        <div className="flex flex-col md:flex-row m-5 my-32 items-center">
          ...
          <div className="basis-1/2 flex flex-col justify-start content-center text-slate-50">
            ...
            <p className="text-xl my-3">
              NotLarvaLabs (NLL) is a community-built royalty-free Marketplace
              for buying and selling CryptoPhunks, built on top of it's own
              custom smart contract with 0% trading fees.
            </p>
            <p className="text-xl mb-10">
              The idea came to life after two Big Corporations (LarvaLabs and
              OpenSea) decided to censor CryptoPhunks.
            </p>
            <Button link="https://notlarvalabs.com/" text="visit" />
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row-reverse m-5 my-32 items-center">
          ...
          <div className="basis-1/2 flex flex-col justify-start content-center text-slate-50">
            ...
            <p className="text-xl my-3">
              CryptoPhunks Auction House was built by Chopper and Kenobi with
              the purpose of facilitating perpetual auctions for CryptoPhunks
              held in the Treasury Vault.
            </p>
            <p className="text-xl mb-10">
              All Ethereum collected from settled auctions will remain in the
              treasury under direction of the community.
            </p>
            <Button link="https://phunks.auction/" text="visit" />
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row m-5 my-32 items-center">
          ...
          <div className="basis-1/2 flex flex-col justify-start content-center text-slate-50">
            ...
            <p className="text-xl mb-10">
              The FlyWheel is a DAPP that appraises mid- and top-tier
              CryptoPhunks and gives holders the option to sell them to the
              Treasury at a small discount to fair market value in a trustless,
              fair, and automatic way.
            </p>
            <Button link="https://www.phunks.pro/" text="visit" />
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row-reverse m-5 my-32 items-center">
          ...
          <div className="basis-1/2 flex flex-col justify-start content-center text-slate-50">
            ...
            <p className="text-xl mb-10">
              The museum of all things Phunky! Take a deep dive into the history
              of the phunks.
            </p>
            <Button link="https://phunks.gitbook.io/" text="visit" />
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto">
        <p className="text-2xl text-slate-50 text-center">
          Built by <Link url="https://twitter.com/soupydolph" title="soupy" />
        </p>
        <p className="text-2xl text-slate-50 text-center">© {year}</p>
      </section>
    </>
  );
}
